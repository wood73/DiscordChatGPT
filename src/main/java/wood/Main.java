...
public class Main {
    ...
    //TODO add a command to reset bot's memory
        ...
        if(validOpenAIKey && foundToken) {
            try {
                ...
                builder.addEventListeners(
                        new CommandHandler(),
                        new MessageHandler((Chat) CommandHandler.commandMap.get(CommandHandler.CHAT_CMD)),
                        new ModalHandler((Chat) CommandHandler.commandMap.get(CommandHandler.CHAT_CMD)),
                        new ReactionHandler());
